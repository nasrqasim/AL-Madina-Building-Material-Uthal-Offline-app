    ...
    <div className="min-h-screen bg-[#050110] text-white selection:bg-purple-500/30 overflow-x-hidden font-sans">
      ...
      <nav className="relative z-50 flex items-center justify-between px-6 py-6 max-w-7xl mx-auto">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-gradient-to-tr from-purple-600 to-indigo-600 rounded-lg flex items-center justify-center font-bold text-lg">{COMPANY_SHORT.charAt(0)}</div>
          <span className="text-xl font-bold tracking-tight">{COMPANY_SHORT}</span>
        </div>
      ...
      <main className="relative z-10 pt-20 pb-32 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
            {COMPANY_NAME} combines advanced financial reporting, inventory intelligence, 
      ...
      <footer className="relative z-10 py-12">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 bg-gradient-to-tr from-purple-600 to-indigo-600 rounded flex items-center justify-center font-bold text-xs text-white">{COMPANY_SHORT.charAt(0)}</div>
            <span className="text-sm font-bold tracking-tight text-white">{COMPANY_SHORT}</span>
          </div>
          
          <div className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] text-center">
            © 2026 {COMPANY_NAME}. All Rights Reserved. Powered by Roonjha Developer.
          </div>
