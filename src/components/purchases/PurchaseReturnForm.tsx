...
export default function PurchaseReturnForm({ onClose, onSave, initialData }: PurchaseReturnFormProps) {
  const [items, setItems] = useState<PRItem[]>(initialData?.items || [
    { id: "1", itemId: "", description: "", qty: 1, unitCost: 0, reason: "", total: 0 }
  ]);
  ...
  const addItem = () => setItems([...items, { id: Date.now().toString(), itemId: "", description: "", qty: 1, unitCost: 0, reason: "", total: 0 }]);
