...
export default function QuotationForm({ onClose, initialData }: QuotationFormProps) {
  const [items, setItems] = useState<QuotationItem[]>(() => {
    ...
    return [{ id: "1", itemId: "", itemCode: "", description: "", cartons: 1, gallons: 4, liters: 16, priceType: "Retail", unitPrice: 0, discPercent: 0, isTaxable: false, taxPercent: 0, total: 0 }];
  });
  ...
  const addItem = () => setItems(prev => [...prev, { id: Date.now().toString(), itemId: "", itemCode: "", description: "", cartons: 1, gallons: 4, liters: 16, priceType: "Retail", unitPrice: 0, discPercent: 0, isTaxable: false, taxPercent: 0, total: 0 }]);
