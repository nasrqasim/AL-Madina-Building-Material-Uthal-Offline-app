...
export default function SaleOrderForm({ onClose, initialData }: SaleOrderFormProps) {
  ...
  const addItem = () => setItems(prev => [...prev, { id: Date.now().toString(), itemId: "", itemCode: "", description: "", cartons: 1, gallons: 4, liters: 16, unitPrice: 0, discPercent: 0, isTaxable: true, taxPercent: 0, total: 0 }]);
