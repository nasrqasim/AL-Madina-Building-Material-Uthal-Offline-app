      ...
      <div className="relative bg-white dark:bg-slate-900 w-full max-w-md rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
        <div className="p-8 border-b border-slate-50 flex items-center justify-between bg-slate-50 dark:bg-slate-800/50/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-black text-slate-800 dark:text-slate-100">{role ? "Edit Role" : "Add New Role"}</h2>
              <p className="text-xs font-medium text-slate-400 dark:text-slate-500 uppercase tracking-widest">Access Control</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Role Name</label>
              <input
                required
                type="text"
                value={formData.name}
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full px-6 py-4 bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 rounded-2xl focus:ring-4 focus:ring-maroon-500/5 focus:border-maroon-500 outline-none transition-all font-bold text-slate-800 dark:text-slate-100 resize-none"
