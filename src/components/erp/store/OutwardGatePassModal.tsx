...
import { Save, Plus, Trash2, Calendar, Clock, Truck, User, MapPin, ClipboardList, ShieldCheck } from "lucide-react";

interface OutwardGatePassModalProps {
  isOpen: boolean;
  onClose: () => void;
  gatePass?: any;
...
export default function OutwardGatePassModal({ isOpen, onClose, gatePass, onSave }: OutwardGatePassModalProps) {
  ...
  return (
    <ERPModal
      isOpen={isOpen}
      onClose={onClose}
      title={gatePass ? "Edit Outward Gate Pass" : "New Outward Gate Pass"}
      size="2xl"
      footer={
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="md:col-span-2 space-y-1.5">
              <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest px-1">Authorized By *</label>
              <div className="relative">
                <ShieldCheck className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-500" size={14} />
                <input
                  type="text"
