...
import { Save, Plus, Trash2, Calendar, User, Briefcase, MapPin, Tag } from "lucide-react";
...
export default function AddStockModal({ isOpen, onClose, adjustment, onSave }: AddStockModalProps) {
  ...
  return (
    <ERPModal
      isOpen={isOpen}
      onClose={onClose}
      title={adjustment ? "Edit Stock Adjustment" : "New Add Stock Adjustment"}
      size="2xl"
      footer={
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2.5 bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 rounded-xl text-sm font-bold focus:bg-white dark:focus:bg-slate-900 dark:bg-slate-900 focus:ring-4 focus:ring-maroon-800/5 outline-none transition-all"
                  required
                />
              </div>
            </div>
            <div className="space-y-1.5">
              <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest px-1">Type *</label>
              <select
                value={formData.type}
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tfoot>
                <tr className="bg-slate-100 dark:bg-slate-800/30 font-black">
                  <td colSpan={5} className="px-4 py-3 text-[10px] text-slate-900 dark:text-white uppercase tracking-widest text-right">Total Value (PKR)</td>
